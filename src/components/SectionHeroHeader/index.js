...
import landingPageImage from '../../images/feri.png'
                    ...
                    <div
                        ...
                        <Swing>
                            <p className="caption-font text-gray-1" data-aos-duration="1000">
                                Hai nama saya Ferri Yusra, biasa disapa Ferri. Saya lulusan baru dari kampus
                                saya di
                                STMIK Jakarta STI&K jurusan Sistem Informasi. <br className="d-md-block d-none" />
                                Saya memiliki minat dibidang web developer dan back end engineering.

                                Saat ini saya terbuka untuk pekerjaan Jr. Website Developer atau Jr. Back End
                                Developer<br className="d-md-block d-none" />
                            </p>
                        </Swing>
                        <a className="btn btn-get d-inline-flex text-white" data-aos-delay="50"
